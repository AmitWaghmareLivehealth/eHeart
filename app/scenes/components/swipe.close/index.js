...
var ModalBox = createReactClass({
  ...
  createPanResponder: function() {
    ...
    var onPanMove = (evt, state) => {
      ...
      // console.log('LIBRARY PAN MOVE', state.dy, this.props.getSwipe());
      // if(state.dy < 1 && !this.props.getSwipe()){
      //    console.log('LIBRARY PAN MOVE change: true');
      //   this.props.setSwipe(true)
      // } else {
      //   console.log('LIBRARY PAN MOVE change: false');
      //  this.props.setSwipe(false)
      // }
    };
  ...
  render: function() {
    ...
    var content = (
      ...
      >
        <View
          style={{ flex: 1, top: Global.isIphoneX ? 18 : 0 }}
          pointerEvents={"box-none"}
